...
public class GraphActivity extends Activity {
	...
	public static final Color[] defaultColors = { new Color(37, 119, 255), new Color(224,0,0), new Color(211,0,224), new Color(0,158,224), new Color(0,255,90), new Color(221,224,0), new Color(224,84,0) };  
